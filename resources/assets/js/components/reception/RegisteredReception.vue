        ...
        <div class="row justify-content-center mt-4">
          ...
          @selection-change="handleSelectionChange">
            ...
            <el-button
              ...
              size="mini"
              @click="viewReception(scope.row)"><i class="fa fa-eye blue"></i></el-button>
            <el-button
              :title="trans('app.editBtnLbl')"
              size="mini"
              @click="editReception(scope.row)"><i class="fa fa-edit blue"></i></el-button>              
						<el-button
              :title="trans('app.deleteBtnLbl')"
						  size="mini"
						  type="danger"
						  @click="deleteReception(scope.row)"><i class="fa fa-trash red"></i></el-button>
					  </template>                    
					</el-table-column>
                    <!--<infinite-loading
                    slot="append"
