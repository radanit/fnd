	  ...
	  <div class="col-md-12">
		...
		<div class="card card-primary card-outline">
		  <div class="card-body box-profile">
			<div class="text-right profile-image">
			<el-upload
			...
			<h3 class="profile-username text-right">{{user.fullname}}</h3>

			<p class="text-right">{{user.roles}}</p>
		  ...
		  <div class="card-body">
			<div class="tab-content">
			  ...
			  <div class="tab-pane" id="settings">
				 <doctor-profile :user="user" v-if="(user.profile_name==='پزشک')"></doctor-profile>
				 <patient-profile :user="user" v-else-if="(user.profile_name==='بیمار')"></patient-profile>
				 <technician-profile :user="user" v-else-if="(user.profile_name==='کاربران رادیولوژی')"></technician-profile>
				 <default-profile :user="user" v-else></default-profile>
			  </div>
			  <!-- /.tab-pane -->
			</div>
			<!-- /.tab-content -->
